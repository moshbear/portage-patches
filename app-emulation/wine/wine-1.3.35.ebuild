...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-msi.patch
	epatch "${FILESDIR}"/${PN}-dxt13-to-argb4444-xrgb1555-conversion-new.patch
	epatch "${FILESDIR}"/${PN}-ddraw.patch
	epatch "${FILESDIR}"/${PN}-dderr.patch
	epatch "${FILESDIR}"/${PN}-undo-b8965ee7c90a687af4c84ad0ede73b1df901e16c.patch
